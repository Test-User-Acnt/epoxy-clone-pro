...
export const reviews: Review[] = [
  ...
  },
  {
    name: "Jag D.",
    location: "Surrey, BC",
    text: "Top-notch service. Had my garage floor done by Go2Epoxy and it exceeded my expectations. Professional crew, high-quality materials, and amazing attention to detail.",
  },
  {
    name: "Aman Kang",
